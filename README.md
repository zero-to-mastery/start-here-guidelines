...
2. On the [GitHub page for this repository](https://github.com/zero-to-mastery/start-here-guidelines), click on the Button "Fork".
   ...
   ![fork image]([https://help.github.com/assets/images/help/repository/fork_button.jpg](https://docs.github.com/assets/cb-28613/images/help/repository/fork_button.png))
